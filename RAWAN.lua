...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RAWANTEAM/Files_RAWAN/master/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevRAWANW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local RAWAN_Msg = ''  
if msgs < 100 then 
RAWAN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
RAWAN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
RAWAN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
RAWAN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
RAWAN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RAWAN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RAWAN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RAWAN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RAWAN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RAWAN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RAWAN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RAWAN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RAWAN_Msg = 'رب التفاعل'  
end 
return RAWAN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceRAWAN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."RAWAN1:List:Filter"..sl)
...
if not DevRAWANW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRAWANW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,RAWAN_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ❏' and DevRAWANW(msg) then  
...
if text == 'تعطيل التواصل ❏' and DevRAWANW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❏' and DevRAWANW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❏' and DevRAWANW(msg) then  
...
if text == 'ضع كليشه ستارت ❏' and DevRAWANW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❏ : ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ❏' and DevRAWANW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❏ : تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ❏' and DevRAWANW(msg) then 
...
send(msg.chat_id_, msg.id_,' *❏ : اصدار سورس روان* \n*❏ : الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ❏' and DevRAWANW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❏ : [تحديثات البوت](t.me/CARLOSTEAMM) \n❏ : [قناه السورس](t.me/CARLOSTEAMM)')
end
if text == "ضع اسم للبوت ❏" and DevRAWANW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❏ : ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ❏' and DevRAWANW(msg) then 
...
if text == 'المشتركين ❏' and DevRAWANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❏ : المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❏' and DevRAWANW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❏ : الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❏") and DevRAWANW(msg) then
...
if text == ("قائمه العام ❏") and DevRAWANW(msg) then
...
if text == ("قائمه الكتم العام ❏") and DevRAWANW(msg) then
...
if text=="اذاعه خاص ❏" and msg.reply_to_message_id_ == 0 and DevRAWANW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❏ : ارسل الان اذاعتك؟* \n*❏ : للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ❏" and msg.reply_to_message_id_ == 0 and DevRAWANW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❏ : ارسل الان اذاعتك؟* \n*❏ : للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ❏" and msg.reply_to_message_id_ == 0 and DevRAWANW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❏ : ارسل الان اذاعتك؟* \n*❏ : للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ❏" and msg.reply_to_message_id_ == 0  and DevRAWANW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❏ : ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ❏" and msg.reply_to_message_id_ == 0  and DevRAWANW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❏ : ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❏' and DevRAWANW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❏" and DevRAWANW(msg) then
...
if text == "تنظيف الكروبات ❏" and DevRAWANW(msg) then 
...
send(msg.chat_id_, msg.id_,'*❏ : عدد الكروبات الان » { '..#group..' }'..RAWANk..''..RAWAN..'*\n*❏ : الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRAWANW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevRAWANW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRAWANW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRAWANW(msg) then
...
local RAWAN1_Msg = database:get(bot_id.."RAWAN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RAWAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if RAWAN_Msg and not Special(msg) then  
local RAWAN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RAWAN_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRAWANW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRAWANW(msg) then
...
if text and text:match("^تغير رساله الاشتراك$") and DevRAWANW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❏ : حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ❏" and DevRAWANW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❏ : تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❏$") and DevRAWANW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❏ : حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❏" and DevRAWANW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ❏" and DevRAWANW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❏ : تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ❏" and DevRAWANW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."RAWAN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RAWAN:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_RAWAN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RAWAN then 
names_RAWAN = database:smembers(bot_id.."RAWAN:blocname"..msg.chat_id_) or ""
if names_RAWAN and names_RAWAN[1] then 
for i=1,#names_RAWAN do 
if name_RAWAN:match("(.*)("..names_RAWAN[i]..")(.*)") then 
...
database:set(bot_id.."RAWAN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RAWAN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RAWAN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RAWAN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RAWAN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RAWANa_new(RAWAN1,RAWAN2)
if RAWAN2 and RAWAN2.first_name_ then 
if RAWAN2.first_name_:match("(.*)"..database:get(bot_id.."RAWAN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RAWAN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RAWAN_nnn = database:get(bot_id.."RAWAN:nump"..msg.chat_id_) or 5
local RAWAN_nnn2 = database:get(bot_id.."RAWAN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RAWAN_nnn2) == tonumber(RAWAN_nnn) or tonumber(RAWAN_nnn2) > tonumber(RAWAN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RAWAN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❏ : عزيزي >>["..RAWAN2.username_.."](https://t.me/"..(RAWAN2.username_ or "CARLOSTEAM")..")\n❏ : عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RAWAN:teh"..msg.chat_id_).."} بجانب اسمك\n❏ : عدد المحاولات المتبقيه {"..(tonumber(RAWAN_nnn) - tonumber(RAWAN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RAWANa_new)
end
end
...
local RAWANChengName = database:get(bot_id.."RAWAN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RAWANChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..RAWANChengName..']')
database:del(bot_id.."RAWAN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RAWANChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."RAWAN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RAWANChengUserName = database:get(bot_id.."RAWAN:Cheng:UserName"..data.id_)
if not data.username_ then 
if RAWANChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RAWANChengUserName..']')
database:del(bot_id.."RAWAN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RAWANChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RAWAN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RAWANChengPhoto = database:get(bot_id.."RAWAN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RAWANChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RAWAN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RAWANChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RAWAN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ʀᴀᴡᴀɴᴛᴇᴀᴍ\n\n[❏  ʀᴀᴡᴀɴᴛᴇᴀᴍ](http://t.me/CARLOSTEAMM)\n\n[❏   ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/CARLOSTEAMM)\n\n[❏   ʀᴀᴡᴀɴ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/D9l9l)\n\n[❏   ʙᴏᴛ ʀᴀᴡᴀɴ](http://t.me/D9l9l)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❏  ʀᴀᴡᴀɴᴛᴇᴀᴍ',url="t.me/CARLOSTEAMM"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevRAWANW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevRAWANW(msg) then
dofile('RAWAN.lua')  
send(msg.chat_id_, msg.id_, ' *❏ : تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRAWANW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRAWANW(msg) then  
function start_function(extra, result, success)
if RAWANSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevRAWANW(msg) then  
...
if RAWANSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❏ : لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevRAWANW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if RAWANSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*❏ : لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRAWANW(msg) then  
function start_function(extra, result, success)
if RAWANSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*❏ : لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevRAWANW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevRAWANW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if RAWANSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*❏ : لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRAWANW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevRAWANW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevRAWANW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevRAWANW(msg) then
...
if DevRAWANW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RAWANTEAM/Files_RAWAN/master/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRAWANW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RAWANTEAM/Files_RAWAN/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRAWANW(msg) then
...
if text == "مسح الملفات" and DevRAWANW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *❏ : تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRAWANW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRAWANW(msg) then  
function start_function(extra, result, success)
...
function Function_RAWAN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RAWAN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RAWAN, nil)
return false 
end
...
database:set(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❏ : ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RAWAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RAWAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❏ : تم منع الكلمه مع التحذير*")  
database:del(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RAWAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RAWAN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RAWAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *❏ : ارسل الكلمه الان*")  
database:set(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAWAN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RAWAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RAWAN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RAWAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAWAN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RAWAN1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevRAWANW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❏ : تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRAWANW(msg) then
...
if text == 'تفعيل الاذاعه' and DevRAWANW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRAWANW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'روان').."" then  
...
send(msg.chat_id_, msg.id_,'['..RAWAN_Msg[math.random(#RAWAN_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRAWANW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,RAWAN)
local t = "\n*ツ قائمة الاعضاء* \n𓍹======𝘙𝘈𝘞𝘈𝘕======𓍻\n"
x = 0
local list = RAWAN.members_
for k, v in pairs(list) do
x = x + 1
...
if RAWANSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevRAWANW(msg) then 
...
if text == ("ردود المطور") and DevRAWANW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❏ : قائمة ردود المطور \n𓍹======𝘙𝘈𝘞𝘈𝘕======𓍻\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRAWANW(msg) then    
send(msg.chat_id_, msg.id_,' *❏ : ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevRAWANW(msg) then    
...
if text == 'تفعيل المغادره' and DevRAWANW(msg) then   
...
if text == 'تعطيل المغادره' and DevRAWANW(msg) then  
...
-- vardump(data) 
RAWANdx(msg.chat_id_, msg.id_, ' *❏ : ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❏ : عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❏ : عدد المحظورين » ( '..data.kicked_count_..' )*\n*❏ : عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRAWANW(msg) then
...
{{text = '𝘚𝘖𝘜𝘙𝘊𝘌 𝘙𝘈𝘞𝘈𝘕', url="t.me/CARLOSTEAMM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ❏ ∫ٴ𓍹======𝘙𝘈𝘞𝘈𝘕======𓍻ٴ❏ ∫○ٴ\n❏ : [𝘚𝘖𝘜𝘙𝘊𝘌 𝘙𝘈𝘞𝘈𝘕](t.me/CARLOSTEAMM) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Mp4', callback_data=id_from_user..":DownloadVid:"..msgidrp..":"..id_from_vid..":Mp4"},{text = 'ogg', callback_data=id_from_user..":DownloadVid:"..msgidrp..":"..id_from_vid..":ogg"}},
...
inline = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 ʀᴀᴡᴀɴ',url='http://t.me/CARLOSTEAMM'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙰𝚁??𝙾𝚂',url='http://t.me/CARLOSTEAMM'}},
}
...
RAWAN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RAWAN)
...
--------------------------------------------------------------------------------------------------------------
SourceRAWAN(data.message_,data)
...
------------------------------------------------------------------------
local RAWANAbot = database:get(bot_id.."RAWAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAWANAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❏ : العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❏ : ["..RAWANAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RAWAN1_Msg = database:get(bot_id.."RAWAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAWAN1_Msg then
send(msg.chat_id_, msg.id_," ❏ : "..RAWAN1_Msg)
